/**
* A sample Lambda function that looks up the latest Amazon Linux 2 AMI ID for a given region.
**/

// Map display OS names to AMI name patterns
var osNameToPattern = {
    "Amazon Linux 2 (x86_64)": "amzn2-ami-hvm-2.0.2019*-x86_64-gp2"
};
...
exports.handler = function(event, context) {
    ...
    // Get the available AMIs for the specified Linux version.
